...
This flow demonstrates basic reading of analog input channels from the IoTextra Analog3 module — a mezzanine board with 8 pseudo-differential analog input channels based on the ADS7828 ADC. Each channel delivers processed voltage or current measurement values via MQTT, displayed in the Node-RED debug sidebar for easy verification and inspection before building further automation logic.
